...
def tempo(): 
    try:
        ...
        api_url = "https://fcc-weather-api.glitch.me/api/current?lat=-2.268097489685087&lon=-46.96676324813969"
...
class mainT(QThread):
    ...
    def run(self):
        ...
        resposta('Tudo pronto para ter um dia cheio de trabalhos')
        self.JARVIS()
    ...
    def JARVIS(self):
        while True:
            ...
            if 'boa noite' in self.Input: #Boa Noite J.A.R.V.I.S
            ...
            elif 'Agradecido' in self.Input: #Muito Obrigado
                resposta('Não precisa agradecer')
                resposta('Estou aqui a sua disposição')
            ...
            elif 'Oi' in self.Input:
	            resposta('olá estava estudando, desculpa')
	            resposta('você precisa de algo?')
                ...
                resposta('Por favor me ajude a dar conta desse retardado')
                ...
                try:
                    with sr.Microphone() as s:
                        ...
                        resposta('Vou pesquisar e apresentar um resumo completo sobre '+speech)
...
class Janela (QMainWindow):
    def __init__(self):
        ...
        self.label_jarvis.setText("JOSYEL")
        ...
        self.label_assv.setText("JARVIS V13")
        ...
        self.label_version.setText("JOSYEL 0.0.2.0")
